...
require 'java_buildpack/container/tc_server/gemfire/gemfire_log4j_api'
require 'java_buildpack/container/tc_server/gemfire/gemfire_log4j_core'
require 'java_buildpack/container/tc_server/gemfire/gemfire_log4j_jcl'
require 'java_buildpack/container/tc_server/gemfire/gemfire_log4j_jul'
require 'java_buildpack/container/tc_server/gemfire/gemfire_log4j_slf4j_impl'
...
module JavaBuildpack
  module Container
    ...
    class TcServerGemfireStore < JavaBuildpack::Component::ModularComponent
      ...
      def client_cache_xml_path
        @droplet.sandbox + 'instance/conf' + client_cache_xml_name
      end
