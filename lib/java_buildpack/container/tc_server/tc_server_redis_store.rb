...
module JavaBuildpack
  module Container
    ...
    # Encapsulates the detect, compile, and release functionality for tc Server redis support.
    class TcServerRedisStore < JavaBuildpack::Component::VersionedDependencyComponent
