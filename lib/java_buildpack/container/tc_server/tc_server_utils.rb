...
module JavaBuildpack
  module Container
    ...
    def context_xml
      tc_server_instance_directory + 'conf/context.xml'
    end
    ...
    def server_xml
      tc_server_instance_directory + 'conf/server.xml'
    end

    # The tc Server instance directory
    #
    # @return [Pathname] the tc Server instance directory
    def tc_server_instance_directory
      @droplet.sandbox + INSTANCE_NAME
    end

    # The tc Server +lib+ directory
    #
    # @return [Pathname] the tc Server +lib+ directory
    def tc_server_lib
      tc_server_instance_directory + 'lib'
    end

    # The Tomcat +webapps+ directory
    #
    # @return [Pathname] the Tomcat +webapps+ directory
    def tc_server_webapps
      tc_server_instance_directory + 'webapps'
    end
